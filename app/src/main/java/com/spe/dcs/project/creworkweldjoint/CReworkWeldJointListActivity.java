...
/**
 * 文件名：CReworkWeldJointListActivity.java
 * 作  者：
 * 时  间：
 * 描  述： 04_施工返修口
 */
public class CReworkWeldJointListActivity extends DaggerAppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private CReworkWeldJointFragment mWaitReportFragment;
    private CReworkWeldJointFragment mReportedFragment;
    private CReworkWeldJointFragment mApproveFragment;
    private CReworkWeldJointFragment mCheckFragment;
    private CReworkWeldJointFragment mCheckAllFragment;
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if ("ConstructionController".equals(back_check)){
                    Intent intent = new Intent(CReworkWeldJointListActivity.this, MainActivity.class);
        ...
        switch (checkedId) {
            ...
            case R.id.rb1:
                if (mWaitReportFragment == null)
                    mWaitReportFragment = CReworkWeldJointFragment.newInstance(CReworkWeldJointFragment.TYPE_WAIT_REPORTED);
            ...
            case R.id.rb2:
                if (mReportedFragment == null)
                    mReportedFragment = CReworkWeldJointFragment.newInstance(CReworkWeldJointFragment.TYPE_REPORTED);
            ...
            case R.id.rb3:
                if (mApproveFragment == null)
                    mApproveFragment = CReworkWeldJointFragment.newInstance(CReworkWeldJointFragment.TYPE_APPROVE);
                transaction.replace(R.id.container, mApproveFragment);
                break;
            //已校验
            case R.id.rb4:
                if (mCheckFragment == null)
                    mCheckFragment = CReworkWeldJointFragment.newInstance(CReworkWeldJointFragment.TYPE_CHECK);
                transaction.replace(R.id.container, mCheckFragment);
                break;
            //全部
            case R.id.rb5:
                if (mCheckAllFragment == null)
                    mCheckAllFragment = CReworkWeldJointFragment.newInstance(CReworkWeldJointFragment.TYPE_CHECK_ALL);
