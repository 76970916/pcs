...
/**
 * 文件名：COpenCutCroListActivity.java
 * 作  者：
 * 时  间：
 * 描  述： 38_施工开挖穿越
 */
public class COpenCutCroListActivity extends DaggerAppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private COpenCutCroFragment mWaitReportFragment;
    private COpenCutCroFragment mReportedFragment;
    private COpenCutCroFragment mApproveFragment;
    ...
    private COpenCutCroFragment mJiaoYanFragment;
    private COpenCutCroFragment mAllFragment;
        ...
        switch (checkedId) {
            ...
            case R.id.rb1:
                if (mWaitReportFragment == null)
                    mWaitReportFragment = COpenCutCroFragment.newInstance(COpenCutCroFragment.TYPE_WAIT_REPORTED);
            ...
            case R.id.rb2:
                if (mReportedFragment == null)
                    mReportedFragment = COpenCutCroFragment.newInstance(COpenCutCroFragment.TYPE_REPORTED);
            ...
            case R.id.rb3:
                if (mApproveFragment == null)
                    mApproveFragment = COpenCutCroFragment.newInstance(COpenCutCroFragment.TYPE_APPROVE);
                transaction.replace(R.id.container, mApproveFragment);
                break;
            //已校验
            case R.id.rb4:
                if (mJiaoYanFragment == null)
                    mJiaoYanFragment = COpenCutCroFragment.newInstance(COpenCutCroFragment.TYPE_JIAOYAN);
                transaction.replace(R.id.container, mJiaoYanFragment);
                break; //全部
            case R.id.rb5:
                if (mAllFragment == null)
                    mAllFragment = COpenCutCroFragment.newInstance(COpenCutCroFragment.TYPE_ALL);
