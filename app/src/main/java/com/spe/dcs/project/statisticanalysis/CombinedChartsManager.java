...
public class CombinedChartsManager {
    private CombinedChart mCombinedChart;
    private YAxis leftAxis;
    private YAxis rightAxis;
    private XAxis xAxis;

    public CombinedChartsManager(CombinedChart combinedChart) {
    ...
    private void initChart() {
        ...
        //显示边界
        mCombinedChart.setDrawBorders(true);//设置图表内格子外的边框是否显示
        mCombinedChart.setTouchEnabled(false); // 设置是否可以触摸
        mCombinedChart.setDragEnabled(false);// 是否可以拖拽
        mCombinedChart.setPinchZoom(false);  //设置x轴和y轴能否同时缩放。默认是否
        mCombinedChart.setDoubleTapToZoomEnabled(false);//设置是否可以通过双击屏幕放大图表。默认是true
        //图例说明
