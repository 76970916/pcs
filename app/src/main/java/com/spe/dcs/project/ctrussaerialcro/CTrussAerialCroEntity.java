 ...
 * Data:
 */
@Entity(tableName = "C_TRUSS_AERIAL_CRO")
public class CTrussAerialCroEntity extends BaseObservable implements Serializable {
     ...
     * 穿越编号
     */
    @ColumnInfo(name = "CROSSING_NUMBER")
     ...
     * 开挖方式
     */
    @ColumnInfo(name = "OPEN_CUT")
    private String openCut;
    /**
     * 穿越长度
     */
    @ColumnInfo(name = "CROSSING_LENGTH")
    private String crossingLength;
    ...
    @Bindable
    public String getOpenCut() {
        return openCut;
    }

    public void setOpenCut(String openCut) {
        this.openCut = openCut;
        notifyPropertyChanged(BR.openCut);
    }
    ...
    public void setCrossingLength(String crossingLength) {
        ...
        notifyPropertyChanged(BR.crossingLength);
    }
    ...
    public void setCrossingNumber(String crossingNumber) {
        ...
        notifyPropertyChanged(BR.crossingNumber);
    }
