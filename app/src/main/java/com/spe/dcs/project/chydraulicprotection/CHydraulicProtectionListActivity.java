...
/**
 * 文件名：CHydraulicProtectionListActivity.java
 * 作  者：
 * 时  间：
 * 描  述： 25_施工水工保护
 */
public class CHydraulicProtectionListActivity extends DaggerAppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private CHydraulicProtectionFragment mWaitReportFragment;
    private CHydraulicProtectionFragment mReportedFragment;
    private CHydraulicProtectionFragment mApproveFragment;
    private CHydraulicProtectionFragment mJiaoYanFragment;
    private CHydraulicProtectionFragment mCheckAllFragment;
        ...
        switch (checkedId) {
            ...
            case R.id.rb1:
                if (mWaitReportFragment == null)
                    mWaitReportFragment = CHydraulicProtectionFragment.newInstance(CHydraulicProtectionFragment.TYPE_WAIT_REPORTED);
            ...
            case R.id.rb2:
                if (mReportedFragment == null)
                    mReportedFragment = CHydraulicProtectionFragment.newInstance(CHydraulicProtectionFragment.TYPE_REPORTED);
            ...
            case R.id.rb3:
                if (mApproveFragment == null)
                    mApproveFragment = CHydraulicProtectionFragment.newInstance(CHydraulicProtectionFragment.TYPE_APPROVE);
            ...
            case R.id.rb4:
                ...
                if (mJiaoYanFragment == null)
                    mJiaoYanFragment = CHydraulicProtectionFragment.newInstance(CHydraulicProtectionFragment.TYPE_JIAOYAN);
                transaction.replace(R.id.container, mJiaoYanFragment);
                break;
            //全部
            case R.id.rb5:
                if (mCheckAllFragment == null)
                    mCheckAllFragment = CHydraulicProtectionFragment.newInstance(CHydraulicProtectionFragment.TYPE_CHECK_ALL);
