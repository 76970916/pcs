...
/**
 * 文件名：CTrussAerialCroListActivity.java
 * 作  者：
 * 时  间：
 * 描  述： 桁架跨越
 */
public class CTrussAerialCroListActivity extends DaggerAppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private CTrussAerialCroFragment mWaitReportFragment;
    private CTrussAerialCroFragment mReportedFragment;
    private CTrussAerialCroFragment mApproveFragment;
    private CTrussAerialCroFragment mJiaoYanFragment;
    private CTrussAerialCroFragment mAllFragment;
        ...
        switch (checkedId) {
            ...
            case R.id.rb1:
                if (mWaitReportFragment == null)
                    mWaitReportFragment = CTrussAerialCroFragment.newInstance(CTrussAerialCroFragment.TYPE_WAIT_REPORTED);
            ...
            case R.id.rb2:
                if (mReportedFragment == null)
                    mReportedFragment = CTrussAerialCroFragment.newInstance(CTrussAerialCroFragment.TYPE_REPORTED);
            ...
            case R.id.rb3:
                if (mApproveFragment == null)
                    mApproveFragment = CTrussAerialCroFragment.newInstance(CTrussAerialCroFragment.TYPE_APPROVE);
                transaction.replace(R.id.container, mApproveFragment);
                break;
            //已校验
            case R.id.rb4:
                if (mJiaoYanFragment == null)
                    mJiaoYanFragment = CTrussAerialCroFragment.newInstance(CTrussAerialCroFragment.TYPE_JIAOYAN);
                transaction.replace(R.id.container, mJiaoYanFragment);
                break; //全部
            case R.id.rb5:
                if (mAllFragment == null)
                    mAllFragment = CTrussAerialCroFragment.newInstance(CTrussAerialCroFragment.TYPE_ALL);
