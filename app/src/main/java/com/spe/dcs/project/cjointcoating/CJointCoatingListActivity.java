...
public class CJointCoatingListActivity extends DaggerAppCompatActivity implements RadioGroup.OnCheckedChangeListener {

    private static final String TAG = "CJointCoatingLisitActivity";
    @Inject
    ViewModelProvider.Factory dcsViewModelFactory;
    CJointCoatingViewModel cAntiCoatingViewModel;
    CommonActivityListBinding binding;
    SysFieldViewModel mSysFieldViewModel;

    private FragmentTransaction transaction;
    private CJointCoatingFragment mWaitReportFragment;
    private CJointCoatingFragment mReportedFragment;
    private CJointCoatingFragment mApproveFragment;
    private CJointCoatingFragment mCheckFragment;
    private CJointCoatingFragment mCheckAllFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.rg.setOnCheckedChangeListener(CJointCoatingListActivity.this);
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if ("ConstructionController".equals(back_check)){
                    Intent intent = new Intent(CJointCoatingListActivity.this, MainActivity.class);
        ...
        switch (checkedId) {
            ...
            case R.id.rb1:
                if (mWaitReportFragment == null)
                    mWaitReportFragment = CJointCoatingFragment.newInstance(CJointCoatingFragment.TYPE_WAIT_REPORTED);
            ...
            case R.id.rb2:
                if (mReportedFragment == null)
                    mReportedFragment = CJointCoatingFragment.newInstance(CJointCoatingFragment.TYPE_REPORTED);
            ...
            case R.id.rb3:
                if (mApproveFragment == null)
                    mApproveFragment = CJointCoatingFragment.newInstance(CJointCoatingFragment.TYPE_APPROVE);
                transaction.replace(R.id.container, mApproveFragment);
                break;
            //已校验
            case R.id.rb4:
                if (mCheckFragment == null)
                    mCheckFragment = CJointCoatingFragment.newInstance(CJointCoatingFragment.TYPE_CHECK);
                transaction.replace(R.id.container, mCheckFragment);
                break;
            //全部
            case R.id.rb5:
                if (mCheckAllFragment == null)
                    mCheckAllFragment = CJointCoatingFragment.newInstance(CJointCoatingFragment.TYPE_CHECK_ALL);
